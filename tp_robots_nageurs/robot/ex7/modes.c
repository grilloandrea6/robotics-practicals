...
volatile float ampl_set  = 40.0;
volatile float ampl;
volatile float phase =  0.5;

const float AMPLITUDE_DECREASE_RATE = 0.1;

const uint8_t NUM_POS = 4;
const uint8_t addresses[NUM_POS] = {72,73,74,21}; // ToDo check addresses, to insert starting from tail
